...
const CurvedLoop = ({
  ...
  return (
    <div
      className={`w-full h-auto flex items-center ${className ?? ""}`}
    ...
    >
      ...
      >
        <text
          ref={measureRef}
          xmlSpace="preserve"
          className="fill-black light:fill-white"
        ...
        {ready && (
          <text xmlSpace="preserve" className={`fill-black light:fill-white ${className ?? ""}`}>
