...
const App = () => {
  ...
  return (
    <>
      ...
      <main
        className="theme-root min-h-screen select-none bg-[var(--bg)] text-[var(--fg)]"
        style={{
          opacity: loading ? 0 : 1,
      ...
      >
        ...
        <div className="flex z-50 items-center justify-between">
          <div className="fixed bottom-6 left-3">
            <button
              className="p-2 rounded-full border border-[var(--fg)] bg-[var(--fg)] text-[var(--bg)] cursor-pointer hover:opacity-80 transition"
              onClick={toggleLight}
